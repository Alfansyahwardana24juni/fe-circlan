        ...
        <div class="content-body">
            <div class="container vh-100">
                <div class="welcome-area">
                    <div class="bg-image bg-image-overlay" style="background-image: url(assets/images/login/pic3.jpg);">
                    </div>
                    <div class="join-area">
                        <div class="started">
                        ...
                        <form action="{{ route('registrasi.submit') }}" method="post">
                            ...
                            <button class="btn btn-primary btn-block mb-3">registrasi</button>
                        </form>
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0);" class="text-light text-center d-block">Don’t have an
                                account?</a>
                            <a href="{{ route('login.tampil')}}" class="btn-link d-block ms-3 text-underline">Signin
                                here</a>
                        </div>
                    </div>
                </div>
