        ...
        <div class="loader-screen" id="splashscreen">
            <div class="main-screen">
                ...
                <div class="brand-logo">
                    <div class="logo">
                        <img src="assets/images/ico.png" alt="spoon-1" class="wow bounceInDown">
                    </div>
        ...
        <div class="content-body">
            <div class="container vh-100">
                <div class="welcome-area">
                    <div class="bg-image bg-image-overlay" style="background-image: url(assets/images/login/pic1.jpg);">
                    </div>
                    <div class="join-area">
                        <div class="mb-3">
                        ...
                        <a href="{{ route('registrasi.tampil')}}" class="btn btn-primary btn-block mb-3">CREATE
                            ACCOUNT</a>
                        <a href="{{ route('login.tampil')}}" class="btn btn-light btn-block mb-3">SIGN IN</a>
